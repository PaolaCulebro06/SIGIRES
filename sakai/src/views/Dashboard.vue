<template>
      ...
      <div class="col-12 xl:12">
        <div class="card">
          <div class="card-content">
            <div class="card-img">
              <img src="public\demo\images\Fondo\bienvenida.png" alt="Imagen de bievenida" width="892" />
            </div>
          </div>
        </div>
      </div>
  ...
  <style scoped>
  .card {
    background: url('/demo/images/Fondo/bienvenida.jpg') no-repeat center center;
